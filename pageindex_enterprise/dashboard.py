...
<body>
  ...
  <script>
    ...
    function renderWorkspaceUsage(usage) {
      ...
      const storageText = `${storage.managed_upload_files || 0} files / ${storage.managed_upload_bytes || 0} bytes / ${storage.orphan_managed_upload_files || 0} orphan`;
      ...
      usageSummary.className = "muted";
      usageSummary.textContent = `${documents.count || 0} docs | ${documents.pages || 0} pages | ${team.members || 0} members | ${team.groups || 0} groups | tokens ${tokenText} | storage ${storageText} | ${conversations.count || 0} chats | ${sourceSets.count || 0} sets | ${retrieval.query_runs || 0} queries | ${audit.events || 0} audit events | doc shares ${documentShareText} | chat shares ${conversationShareText} | set shares ${sourceSetShareText}`;
